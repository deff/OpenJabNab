...
if(!empty($_POST['a'])) {
	...
	elseif($_POST['a']=="setupmac") {
		$bwake = isset($_POST['bwake'])
	$retour = $ojnAPI->getApiString("bunny/".$_SESSION['bunny']."/foo/setmac?mac=".urlencode($_POST['mac'])."&wake=".$bwake."&".$ojnAPI->getToken());
...
<input type="text" name="fpath" value="chemin de foobar"/>
<input type="text" name="fmac" value="mac du pc a allumer" />
<input type="checkbox" name="bwake" value="allumer le pc" />
<table>
<tr>
	<th>Jour</th>
	<th>Lever</th>
